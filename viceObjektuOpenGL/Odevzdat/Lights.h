...
public:
	SpotLight(float angle = 30.5f, glm::vec3 direction = glm::vec3(0.0f), glm::vec3 position = glm::vec3(0.0f), glm::vec3 color = glm::vec3(1.0f), float intensity = 1.0f, float constant = 1.0f, float linear = 0.2f, float quadratic = 0.0f);
	glm::vec3 direction;
	float angle;
